...
# IMPORTANT: this must be defined BEFORE any /{trip_id}/... routes.
# FastAPI matches routes in order — if /{trip_id}/run-all is registered first,
# "merged" gets matched as a trip_id and returns 404.
